...
O desafio teve como objetivo avaliar conhecimentos práticos na plataforma **ServiceNow**, incluindo configuração de aplicações, modelagem de dados, controle de acesso e entendimento dos conceitos básicos de ITSM e desenvolvimento low-code/no-code.

---

## 🎯 Objetivo do Desafio

Construir uma aplicação funcional no **ServiceNow** que simule um cenário real de negócio, aplicando boas práticas da plataforma, organização de dados e controle de permissões por perfil de usuário.
...
Este desafio foi uma experiência extremamente enriquecedora, permitindo aplicar conceitos técnicos em um cenário próximo ao real, além de reforçar o interesse em seguir evoluindo na plataforma **ServiceNow**.

Agradeço a oportunidade de participar da 3º temporada do **Shark Academy / Shark Evolution** e de demonstrar meu comprometimento, esforço e vontade de aprender.
